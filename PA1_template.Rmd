...
png(filename = "figure/step_freq.png")
hist(totalStepData,
     breaks = 10,
...
![Histogram of steps per day](figure/step_freq.png)
...
png(filename = "figure/daily_pattern.png")
plot(names(pattern), 
     pattern, 
...
![Daily pattern of steps by time interval](figure/daily_pattern.png)
...
```{r,echo=TRUE}
png(filename = "figure/step_freq_imputed.png")
...
![Histogram of steps per day](figure/step_freq_imputed.png)
...
png(filename = "figure/weekday_vs_weekend_pattern.png",
...
![Daily pattern of steps by time interval](figure/weekday_vs_weekend_pattern.png)
